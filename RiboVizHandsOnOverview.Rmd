...
Example Datasets is a place to start: 

https://github.com/riboviz/example-datasets

## Example Datasets Repository can help
...
- UMI-tools allows flexible descriptions of barcodes and UMIs
...
One of the benefits of riboviz is our comprehensive documentation for users, and developers. 

This helps make it easier to get running with riboviz, as well as giving lots of information on how to configure and adapt riboviz for your dataset and to assist with your specific research questions.
Key guides include:
